...
final class AppAssembly {
    ...
    private lazy var settingsAssembly: SettingsAssembly = SettingsAssembly(webService: webService, navigationController: navigationController)
    ...
    private lazy var profileAssembly: ProfileAssembly = ProfileAssembly(repository: webService, settingsAssembly: settingsAssembly)
